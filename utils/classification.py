...
model = tf.keras.models.load_model(('./models/classification/phase1/fashion.h5'),custom_objects={'KerasLayer':hub.KerasLayer})
...
BATCH_SIZE = 64
classes = ['blazer', 'burkha', 'headwear', 'longpants', 'scarf', 'sweater', 'vest', 'bags', 'chudidar', 'hoddie', 'jeans', 'jersey', 'kurta', 'saree', 'shirt', 'shoes', 'skirt', 'strip-dress', 'sunglasses', 'tops', 'trousers', 'tshirt']
